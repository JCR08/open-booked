    ...
    return(
      <div className="container">
        ...
        <section className="hotels row">
          ...
          <div className="card col s4 center-align">
            <Link to='/hotels'>
              <img className="responsive-img" src="https://secure.parksandresorts.wdpromedia.com/resize/mwImage/1/640/360/75/wdpromedia.disney.go.com/media/wdpro-assets/gallery/resorts/contemporary/rooms/non-accessible/ck/room-ck-g07.jpg?07072014201237" alt="Hotels"/>
              <div><b>Hotels</b></div>
            </Link>
          </div>
          <div className="card col s4 center-align">
